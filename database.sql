...
CREATE TABLE `client` (
  ...
  `job_status` enum('Employed','Unemployed','Student','Retired') DEFAULT NULL,
...
INSERT INTO `client` VALUES (1,'Nabeul','Nabeul','Female',24,'Employed','Single',0),(2,'Tunis','Tunis','Male',30,'Employed','Married',1),(3,'gafsa','metlaoui','Male',18,'Student','Single',0);
...
-- Dump completed on 2025-01-13 20:09:45
